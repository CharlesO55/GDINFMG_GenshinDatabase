...
$sql3a = "DROP TABLE IF EXISTS view_character_queries";
$sql3b = "CREATE TABLE view_character_queries AS
	SELECT character_id, character_name, rarity, vision, weapon_type, region, model FROM table_masterlist";
...
******************************/
//$sql4 = "DROP VIEW IF EXISTS view_max_stats";
/*"CREATE OR REPLACE VIEW view_max_stats AS
	SELECT character_name, atk_90_90, def_90_90, hp_90_90 FROM table_masterlist";*/

/*****************************
* #5 Create Base Stats View  *
******************************/    
//$sql5 = "DROP VIEW IF EXISTS view_base_stats";
/*"CREATE OR REPLACE VIEW view_base_stats AS
	SELECT character_name, atk_1_20, def_1_20, hp_1_20 FROM table_masterlist";*/

/***********************************
* #6 CREATING ASCENSION REQS VIEW  *
************************************/
//$sql6 = "DROP VIEW IF EXISTS view_ascension_reqs"; 
/*"CREATE OR REPLACE VIEW view_ascension_reqs AS
...
************************************/
// $sql7 = "DROP VIEW IF EXISTS view_special_stats";
/*"CREATE OR REPLACE VIEW view_special_stats AS
...
************************************/
// $sql8 = "DROP VIEW IF EXISTS view_talent_reqs";
/*"CREATE OR REPLACE VIEW view_talent_reqs AS
...
//     FROM table_masterlist";
$sql9a = "DROP TABLE IF EXISTS view_character_release";
$sql9b = "CREATE TABLE view_character_release  AS
	SELECT character_id, character_name, release_date, limited, voice_en, voice_cn, voice_jp, voice_kr 
    FROM table_masterlist";    
...
//     FROM table_masterlist";
$sql10a = "DROP TABLE IF EXISTS view_character_general";
$sql10b = "CREATE TABLE view_character_general AS
	SELECT character_id, character_name, rarity, vision, weapon_type, region, model, arkhe, constellation, birthday, special_dish, affiliation, character_description
    FROM table_masterlist";
/***********************************
...
// 	FROM table_masterlist;";
$sql11a = "DROP TABLE IF EXISTS view_leveling_reqs";
$sql11b = "CREATE TABLE view_leveling_reqs AS
	SELECT character_id, character_name, ascension_specialty, ascension_material, ascension_boss, ascension_gem,
    talent_material, `talent_book_1-2`, `talent_book_2-3`, `talent_book_3-4`, `talent_book_4-5`, `talent_book_5-6`, `talent_book_6-7`, `talent_book_7-8`, `talent_book_8-9`, `talent_book_9-10`, talent_weekly
    FROM table_masterlist";
...
// 	FROM table_masterlist";
$sql12a = "DROP TABLE IF EXISTS view_character_stats";
$sql12b ="CREATE TABLE view_character_stats AS
	SELECT character_id, character_name, atk_1_20, def_1_20, hp_1_20, atk_90_90, def_90_90, hp_90_90, ascension, special_0, special_6
	FROM table_masterlist";

mysqli_query($CONNECTION, $sql3a) or die("[3a] Character Query view failed");
mysqli_query($CONNECTION, $sql3b) or die("[3b] Character Query view failed");
...
mysqli_query($CONNECTION, $sql9a) or die("[9a] Char release view failed");
mysqli_query($CONNECTION, $sql9b) or die("[9b] Char release view failed");
mysqli_query($CONNECTION, $sql10a) or die("[10a] Char general view failed");
mysqli_query($CONNECTION, $sql10b) or die("[10b] Char general view failed");
mysqli_query($CONNECTION, $sql11a) or die("[11a] Char leveing reqs view failed");
mysqli_query($CONNECTION, $sql11b) or die("[11b] Char leveing reqs view failed");
mysqli_query($CONNECTION, $sql12a) or die("[12a] Char stats view failed");
mysqli_query($CONNECTION, $sql12b) or die("[12b] Char stats view failed");
